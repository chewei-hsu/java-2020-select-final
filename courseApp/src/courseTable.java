...
public class courseTable {
    ...
    // render the content of the course table (according to data).
    public void tableRender(){
        ...
        // oof... here's a lot of code.
        // don't worry, as the elements are named by some rule so codes can and are generated by a light program.
        // we didn't write them all by typing. (it's surely a nightmare)

        // mapping all the generated content to the target JPanel.
